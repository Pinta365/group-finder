...
if GetLocale() == "deDE" then
    ...
    ["HIDE_BLOODLUST_GROUPS"] = "Gruppen mit Kampfrausch/Heldentum ausblenden",
    ["HIDE_BLOODLUST_GROUPS_DESC"] = "Zeige nur Gruppen, die noch keine Kampfrausch/Heldentum-Klasse haben. Zählt nur die gelisteten Gruppenmitglieder, deine eigene Klasse blendet also nichts aus. Nützlich, wenn du selbst Kampfrausch mitbringst.",
    ...
    ["HAS_BLOODLUST"] = "Hat Kampfrausch/Heldentum",
    ["HAS_BLOODLUST_DESC"] = "Zeige nur Gruppen, die nach deinem Beitritt Kampfrausch/Heldentum haben. Zählt Magier, Schamanen, Rufer und Jäger in der Gruppe sowie dich und deine Gruppe.",
    ["SHOW_BLOODLUST_ICON"] = "Kampfrausch-Symbol anzeigen",
    ["SHOW_BLOODLUST_ICON_DESC"] = "Zeigt ein Symbol bei Dungeon-Suchergebnissen, deren Gruppe bereits eine Kampfrausch/Heldentum-Klasse enthält.",
    ...
    ["SHOW_AGE"] = "Alter der Auflistung anzeigen",
    ["SHOW_AGE_DESC"] = "Zeigt an, wie lange die Gruppe bereits in den Suchergebnissen gelistet ist.",
