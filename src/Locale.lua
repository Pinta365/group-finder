...
local defaultLocale = {
    ...
    ["HAS_BLOODLUST"] = "Has Bloodlust/Hero",
    ["HAS_BLOODLUST_DESC"] = "Only show groups that will have Bloodlust/Heroism once you join. Counts Mages, Shamans, Evokers and Hunters in the group, plus you and your party.",
    ["HIDE_BLOODLUST_GROUPS"] = "Hide groups with Bloodlust/Hero",
    ["HIDE_BLOODLUST_GROUPS_DESC"] = "Only show groups that do not already have a Bloodlust/Heroism class. Counts only the listed group members, so your own class never hides results. Useful when you bring lust yourself and want groups that still need it.",
    ...
    ["BOSS_RANGE"] = "Bosses defeated:",
    ["BOSS_RANGE_MIN"] = "Min",
    ["BOSS_RANGE_MIN_DESC"] = "Only show groups that have defeated at least this many bosses. Leave empty for no minimum.",
    ["BOSS_RANGE_MAX"] = "Max",
    ["BOSS_RANGE_MAX_DESC"] = "Only show groups that have defeated at most this many bosses. Leave empty for no maximum. Set both to 0 for fresh runs only.",
    ["BOSS_FILTER_ANY"] = "Any",
    ...
    ["SORT_BOSS_PROGRESS"] = "Bosses Defeated",
    ...
    ["MOVE_PENDING_GROUPS_TO_TOP"] = "Move pending groups to top",
    ["MOVE_PENDING_GROUPS_TO_TOP_DESC"] = "Keep groups you have already applied to above other search results.",
    ...
    ["SHOW_BLOODLUST_ICON"] = "Show bloodlust icon",
    ["SHOW_BLOODLUST_ICON_DESC"] = "Show an icon on dungeon search results whose group already contains a Bloodlust/Heroism class.",
    ...
    ["SHOW_AGE"] = "Show listing age",
    ["SHOW_AGE_DESC"] = "Show how long ago the group was listed next to the group name.",
    ...
    ["SHOW_RAID_BOSS_PROGRESS"] = "Show boss progress",
    ["SHOW_RAID_BOSS_PROGRESS_DESC"] = "Show how many of the raid's bosses the group has already defeated, e.g. 6/8.",
